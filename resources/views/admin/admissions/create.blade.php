...
@section('page-title', 'Create Admission')
...
@section('content')
    <div class="create-admission-page">
        ...
        <div class="hero-card">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 position-relative">
                <div>
                    ...
                    <h2 class="fw-bold mb-2">Create Admission</h2>
                    <p class="mb-0 text-light-soft">
                        Add a new admission fee structure to the system
                    </p>
                </div>
                <div class="text-end">
            ...
            <div class="form-body">
                ...
                <div class="info-box">
                    ...
                    <div class="info-box-text">
                        Fill in the details below to create a new admission fee structure. 
                ...
                <form action="{{ route('admin.admissions.store') }}" method="POST">
                    ...
                    <div class="input-group-custom">
                        ...
                        <textarea name="note"
                                  ...
                                  placeholder="Enter any additional notes or description about this admission...">{{ old('note') }}</textarea>
                        @error('note')
                            <div class="error-message">
                                <i class="bi bi-exclamation-triangle-fill"></i> {{ $message }}
                            </div>
                    ...
                    <div class="action-buttons">
                        <button type="submit" class="btn-save">
                            <i class="bi bi-check-lg"></i> Save Admission
                        </button>
        ...
        <div class="text-center mt-3">
            <small class="text-muted">
                ...
                All admission records are securely stored and can be managed from the admissions list
            </small>
        </div>
