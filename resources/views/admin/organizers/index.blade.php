    ...
    <div class="organizers-page">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stats-card">
                    ...
                    <div>
                        <h3>{{ \App\Models\Organizer::where('is_active', 1)->count() }}</h3>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stats-card">
                    ...
                    <div>
                        <h3>{{ \App\Models\Organizer::where('is_active', 0)->count() }}</h3>
                        <p>Inactive Organizers</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stats-card">
                    ...
                    <div>
                        <h3>{{ \App\Models\Organizer::whereNotNull('code')->count() }}</h3>
        ...
        <div class="main-card">
            ...
            <div class="main-card-header">
                ...
                <div>
                    <h4>Organizers Management</h4>
                    <p>Manage organizer profiles and account status</p>
                </div>

                <div class="header-buttons">

                    <a href="{{ route('admin.organizers.create') }}" class="btn btn-primary custom-btn">
                        <i class="bi bi-plus-lg"></i>
                        Add Organizer
                    </a>

                    <a href="{{ route('admin.organizers.export.excel') }}" class="btn btn-success custom-btn">
                    ...
                    <a href="{{ route('admin.organizers.export.pdf') }}" class="btn btn-danger custom-btn">
                    ...
                    <a href="{{ route('admin.organizer-payments.index') }}" class="btn btn-light border custom-btn">
            ...
            <div class="search-card">
                ...
                <form method="GET" action="{{ route('admin.organizers.index') }}">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6">
                            <div class="search-input-wrapper">
                                ...
                                <input type="text" name="search" class="form-control custom-input"
                                    placeholder="Search name / mobile / code / NIC" value="{{ request('search') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <a href="{{ route('admin.organizers.index') }}" class="btn btn-light border w-100 custom-btn">
                                Reset
                            </a>
                        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="action-buttons">
                                        ...
                                        <a href="{{ route('admin.organizers.show', $organizer) }}" class="action-btn view-btn">
                                            <i class="bi bi-eye-fill"></i>
                                        </a>

                                        <a href="{{ route('admin.organizers.edit', $organizer) }}" class="action-btn edit-btn">
                                            <i class="bi bi-pencil-fill"></i>
                                        </a>

                                        <form method="POST" action="{{ route('admin.organizers.toggleActive', $organizer) }}"
